          ...
          <Card>
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <Button variant="outline" className="w-full justify-start bg-transparent hover:bg-muted group" asChild>
                  <a href="https://instagram.com/paseo_shopp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                    <div 
                      className="flex items-center justify-center h-6 w-6 rounded transition-all group-hover:scale-110"
                      style={{
                ...
                <Button variant="outline" className="w-full justify-start bg-transparent hover:bg-muted group" asChild>
                  <a href="https://facebook.com/paseo_shopp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                    <div className="flex items-center justify-center h-6 w-6 rounded bg-[#1877F2] transition-all group-hover:scale-110">
                      <svg
                        className="h-4 w-4"
                        fill="white"
                        viewBox="0 0 24 24"
