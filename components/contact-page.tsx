            ...
            <CardContent className="p-6">
              ...
              <div className="space-y-3">
                <Button variant="outline" className="w-full justify-start bg-transparent hover:bg-muted" asChild>
                  <a href="https://instagram.com/paseoshopp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
                    <div 
                ...
                <Button variant="outline" className="w-full justify-start bg-transparent hover:bg-muted" asChild>
                  <a href="https://facebook.com/paseoshopp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2">
