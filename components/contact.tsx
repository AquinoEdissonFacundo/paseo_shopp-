                ...
                <div>
                  ...
                  <div className="flex flex-col gap-3">
                    <Button variant="outline" className="w-full justify-start gap-3 bg-transparent hover:bg-muted" asChild>
                      <a href="https://instagram.com/paseoshopp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                        <div 
                    ...
                    <Button variant="outline" className="w-full justify-start gap-3 bg-transparent hover:bg-muted" asChild>
                      <a href="https://facebook.com/paseoshopp" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3">
                        <div className="flex items-center justify-center h-8 w-8 rounded-lg bg-[#1877F2]">
                          <svg
                            className="h-5 w-5"
                            fill="white"
                            viewBox="0 0 24 24"
